...
// FIX: Standardize all icon components to accept React.SVGProps for better type safety and to allow passing attributes like x, y, className etc.
...
export const AndroidIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M16 8H8a2 2 0 0 0-2 2v3.5a3.5 3.5 0 0 0 7 0V10a2 2 0 0 0-2-2m-4 5a1.5 1.5 0 1 1 1.5-1.5A1.5 1.5 0 0 1 12 13m8.5-7.5a.5.5 0 1 0 .5.5.5.5 0 0 0-.5-.5m-13 0a.5.5 0 1 0 .5.5.5.5 0 0 0-.5-.5m10.15 1.15L16.2 3.2a1 1 0 0 0-1.4 0L13 4.93a7.49 7.49 0 0 0-2 0L9.2 3.2a1 1 0 0 0-1.4 0L6.35 4.65a1 1 0 0 0 0 1.4L7.5 7.2A8.44 8.44 0 0 0 5 10.5V17a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-6.5a8.44 8.44 0 0 0-2.5-3.3l1.15-1.15a1 1 0 0 0 0-1.4Z"/>
    </svg>
);
...
export const DocumentArrowRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const ServerStackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m-3.75-3.75v3.75m-3.75-3.75v3.75m9.75-15l-2.437-2.438a2.25 2.25 0 00-3.182 0l-2.437 2.438h11.25zM6 6.375v3.75m3.75-3.75v3.75m3.75-3.75v3.75m3.75-3.75v3.75M4.5 12.75h15" />
  </svg>
);
...
export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-2.408M6.115 5.468a9.337 9.337 0 012.258-2.408 9.38 9.38 0 014.266 0 9.337 9.337 0 012.258 2.408m-12.483 10.192a9.337 9.337 0 01-2.258-2.408 9.38 9.38 0 010-4.266 9.337 9.337 0 012.258-2.408m12.483 10.192L16.25 13.5m-6.5 0L3.75 5.875M12 12m0 4.5l-2.25-2.25m2.25 2.25l2.25-2.25M12 12m0-4.5L14.25 9.75M12 12L9.75 9.75" />
  </svg>
);
...
export const TvIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m-3.75-3.75v3.75m-3.75-3.75v3.75m9.75-15l-2.437-2.438a2.25 2.25 0 00-3.182 0l-2.437 2.438h11.25zM12 9.75v6.75m3-3h-6" />
  </svg>
);
...
export const ClipboardDocumentListIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 8.25V6a2.25 2.25 0 00-2.25-2.25H6A2.25 2.25 0 003.75 6v8.25A2.25 2.25 0 006 16.5h2.25m8.25-8.25H18a2.25 2.25 0 012.25 2.25v8.25A2.25 2.25 0 0118 20.25h-7.5A2.25 2.25 0 018.25 18v-1.5m8.25-8.25h-6a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25h6a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25z" />
  </svg>
);
...
export const SignalIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 8.25V18a2.25 2.25 0 002.25 2.25h13.5A2.25 2.25 0 0021 18V8.25m-18 0V6a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 6v2.25m-18 0h18M5.25 6h.008v.008H5.25V6zM7.5 6h.008v.008H7.5V6zm2.25 0h.008v.008h-.008V6z" />
  </svg>
);

export const SignalSlashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 3l18 18M21 8.25v-2.25a2.25 2.25 0 00-2.25-2.25H8.25L3 8.25M21 8.25v9.75a2.25 2.25 0 01-2.25 2.25H5.25a2.25 2.25 0 01-2.25-2.25V15M3 8.25h.75m3 0h.75M9 8.25h.75m3 0h.75m3 0h.75M5.25 6h.008v.008H5.25V6z" />
  </svg>
);
...
export const PaintBrushIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.362-3.797zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);
...
export const SupabaseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M11.233 2.247a1.442 1.442 0 0 0-2.066 0L1.133 9.71a1.442 1.442 0 0 0-.25 1.59l4.433 10.457a1.442 1.442 0 0 0 1.95.73l6.5-2.775 6.5 2.775a1.442 1.442 0 0 0 1.95-.73L23.1 11.3a1.442 1.442 0 0 0-.25-1.59l-8.034-7.463Z" fill="#3ECF8E"/>
    <path d="M12.717 19.742a1.442 1.442 0 0 0-1.033 0l-6.5 2.775a1.442 1.442 0 0 0-1.95-.73L.767 19.34a1.442 1.442 0 0 0-.75 1.59c.75 3.375 3.983 5.492 7.35 4.742l4.166-1.167a1.442 1.442 0 0 1 1.434 0l4.166 1.167c3.367.75 6.6-1.367 7.35-4.742a1.442 1.442 0 0 0-.75-1.59l-2.45-2.446a1.442 1.442 0 0 0-1.95.73l-6.5-2.775Z" fill="#3ECF8E"/>
  </svg>
);

export const FirebaseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M5.96 18.174l-1.36 4.348L18.6 9.015l-3.34-5.22z" fill="#FFC24A"/>
    <path d="M5.96 18.174l7.636-16.126-2.004-.313-9.98 12.016z" fill="#FFA712"/>
    <path d="M12.018 20.317l6.582-11.302-3.13-1.89-6.91 4.545z" fill="#F4BD62"/>
    <path d="M5.96 18.174l.056 2.373L12.018 20.317l-3.342-6.688z" fill="#F6820C"/>
  </svg>
);

export const VercelIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}><path d="M12 1.5l12 21H0L12 1.5z"/></svg>
);

export const NetlifyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M2.203 16.326a.5.5 0 0 0 .543.674l8.25-2.5a.5.5 0 0 0 .193-.895l-5.61-4.207a.5.5 0 0 0-.82.357v6.571Zm19.594-8.652a.5.5 0 0 0-.543-.674l-8.25 2.5a.5.5 0 0 0-.193.895l5.61 4.207a.5.5 0 0 0 .82-.357V7.674Z" fill="#4D9ABF"/>
    <path d="M11.189 12.836a.5.5 0 0 0 .307.643l5.068 2.027a.5.5 0 0 0 .624-.559l-2.027-8.108a.5.5 0 0 0-.61-.38l-4.225 1.69a.5.5 0 0 0 .137 1.01l1.58-.632.85 3.4-1.704-.681ZM2.75 6.81a.5.5 0 0 0 .61.38l4.225-1.69a.5.5 0 0 0-.137-1.01l-1.58.632-.85-3.4L6.722.94a.5.5 0 0 0-.624.559L4.07 9.607a.5.5 0 0 0 .307-.643L2.75 6.81Z" fill="#00C7B7"/>
  </svg>
);

export const AwsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}><path d="M13.43 16.537c-.31.02-.62.03-.93.03-.31 0-.62-.01-.93-.03l-1.34-3.655-3.13 1.34 2.22 6.027a1.21 1.21 0 0 0 1.15.824h4.04a1.21 1.21 0 0 0 1.15-.824l2.22-6.027-3.13-1.34zM16.126 9.636l-2.48 6.74h-3.29l-2.48-6.74 3.99-1.776zM15.894 4.568l-3.46 9.387-2.87-1.226 2.52-6.845-2.06-5.594a1.2 1.2 0 0 1 1.12-.294l4.5 1.58a1.2 1.2 0 0 1 .49.992z" fill="#FF9900"/></svg>
);

export const XanoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="m15.86 12-4.95 4.95-4.95-4.95 4.95-4.95 4.95 4.95Z" fill="#FFD95D"/>
    <path d="M10.91 7.05 6.3 11.66c-.34.34-.09.91.38.91h8.64c.47 0 .72-.57.38-.91l-4.61-4.61c-.2-.2-.55-.2-.75 0Z" fill="#3D86F4"/>
    <path d="m17.66 12.35-4.61 4.61c-.2.2-.55.2-.75 0l-4.61-4.61c-.34-.34-.09-.91.38-.91h8.64c.47 0 .72.57.38.91Z" fill="#13366E"/>
  </svg>
);

export const BackendlessIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-1 15v-5h2v5h-2zm0-7V8h2v2h-2z" fill="#00BFFF"/>
    <path d="M12 2v20c5.523 0 10-4.477 10-10S17.523 2 12 2z" fill="#1E90FF"/>
  </svg>
);
