...
{/* FIX: Update component to accept all SVG props to fix type errors when used with x/y attributes. */}
export const ServerStackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 21v-5.25A2.25 2.25 0 019 13.5h6a2.25 2.25 0 012.25 2.25V21M3 3h18M3 7.5h18M3 12h18" /></svg>
);
...
export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M12 3.375c-3.418 0-6.162 2.755-6.162 6.188s2.744 6.188 6.162 6.188 6.162-2.755 6.162-6.188S15.418 3.375 12 3.375z" /></svg>
);
...
export const AndroidIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.1 12.9C4.1 12.9 4 13 4 13.2s0 0.3.1.3c.1.1.2.1.2.1h.2c.2 0 .4-.1.4-.4s-.2-.4-.4-.4h-.2c-.1 0-.1.1-.1.2zM6.5 13.4c-.2 0-.4.2-.4.4s.2.4.4.4.4-.2.4-.4-.2-.4-.4-.4zM18 10.1c0-.2.1-.3.2-.3s.3.1.3.2c0 .2-.1.3-.2.3s-.3-.1-.3-.2zm-2.1 3.2h.2c.2 0 .4-.2.4-.4s-.2-.4-.4-.4h-.2c-.2 0-.4.2-.4.4s.2.4.4.4zm2.1 0c.2 0 .4-.2.4-.4s-.2-.4-.4-.4-.4.2-.4.4.2.4.4.4zm-1.1-5.1c-.2 0-.4.2-.4.4s.2.4.4.4.4-.2.4-.4-.2-.4-.4-.4z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.2 6.4c-.2 0-.2.2 0 .2l-1 .5c-.2 0-.2.2 0 .2s.2-.2.2-.2l1-.5s.2-.2 0-.2zm-6.4 0c.2 0 .2.2 0 .2l1 .5s.2.2 0 .2-.2-.2-.2-.2l-1-.5c-.2-.2 0-.2 0-.2z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.9 14.2c-.3-.1-.5-.1-.5.1s.1.4.4.4.5-.1.5-.1-.1-.4-.4-.4zM16.1 14.8c-.2 0-.4.2-.4.4s.2.4.4.4.4-.2.4-.4-.2-.4-.4-.4zm-8.2.8c.2 0 .4-.2.4-.4s-.2-.4-.4-.4-.4.2-.4.4.2.4.4.4zm-3.8-.4c.3 0 .4.2.4.4s-.2.4-.4.4c-.3 0-.5-.2-.5-.4s.2-.4.5-.4z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.4 13.9c-.2 0-.4.2-.4.4s.2.4.4.4.4-.2.4-.4-.2-.4-.4-.4zM12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm5.1 16.3c-.2.2-.4.2-.7 0-2.3-1.6-4-2.8-6.9-2.8s-4.6 1.1-6.9 2.8c-.2.2-.5.1-.7 0s-.1-.5 0-.7c2.4-1.7 4.2-3 7.2-3s4.8 1.3 7.2 3c.2.2.2.5 0 .7z" />
    </svg>
);
