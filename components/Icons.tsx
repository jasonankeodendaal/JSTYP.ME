...
export const AndroidIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
        <path d="M15.94,5.32c-.07-.49-.46-.82-.94-.82H9c-.48,0-.87,.33-.94,.82L6.15,13H17.85Zm-1.44,5.43a.75,.75,0,1,1,1.5,0,.75,.75,0,1,1-1.5,0Zm-5,0a.75,.75,0,1,1,1.5,0,.75,.75,0,1,1-1.5,0ZM18.5,14H5.5a1,1,0,0,0-1,1.21l1.17,2.37a1,1,0,0,0,.92,.63h11a1,1,0,0,0,.92-.63l1.17-2.37a1,1,0,0,0-1-1.21Z" />
    </svg>
);
...
export const CloudSlashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.05 4.91A7.5 7.5 0 0117.25 6H18a4.5 4.5 0 014.5 4.5 4.5 4.5 0 01-4.5 4.5H9.75a4.5 4.5 0 01-4.47-4.089m1.25-8.257a5.25 5.25 0 00-6.42 6.42m1.25-8.257L4.5 21" />
  </svg>
);
...
export const WhatsAppIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M12.04 2C6.58 2 2.13 6.45 2.13 12c0 1.77.46 3.45 1.29 4.95L2 22l5.25-1.38c1.45.77 3.09 1.18 4.79 1.18h.01c5.46 0 9.91-4.45 9.91-9.91S17.5 2 12.04 2m-1.22 15.15c-.27.13-.59.2-1.07.33-.53.13-1.02.13-1.54.08-.59-.05-1.17-.23-1.69-.53-.53-.3-1-.7-1.4-1.19-.41-.49-.73-.99-.96-1.52s-.35-1.09-.35-1.69c0-.6.12-1.18.35-1.71s.59-1.04.98-1.49c.39-.45.85-.8 1.36-1.04.52-.24 1.07-.36 1.64-.36.57 0 1.12.12 1.62.36s.93.59 1.28 1.03c.36.44.63.95.82 1.52.19.57.29 1.17.29 1.79 0 .73-.14 1.4-.41 2.02-.27.62-.67 1.14-1.2 1.57-.53.42-1.14.74-1.82.95m4.38-3.23c-.22-.11-1.3-.65-1.5-.72-.2-.07-.35-.11-.5.11-.15.22-.57.72-.7.87-.13.15-.26.17-.48.06-.22-.11-.94-.34-1.79-1.1-.66-.59-1.1-1.32-1.23-1.54s-.02-.34.1-.45c.11-.1.24-.28.36-.42.12-.14.16-.23.25-.39.09-.15.04-.28-.02-.39-.07-.11-.5-1.2-.68-1.64-.18-.44-.37-.38-.5-.38h-.4c-.15 0-.39.06-.59.3-.2.24-.76.75-.76 1.83s.78 2.12.89 2.27c.11.15 1.53 2.33 3.71 3.28.52.23.93.36 1.26.46.6.18 1.14.16 1.56.09.48-.08 1.3-.53 1.48-1.04.18-.51.18-.95.13-1.04-.05-.09-.19-.15-.41-.26" />
  </svg>
);
...
// FIX: Added missing PaintBrushIcon.
export const PaintBrushIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.47 2.118 2.25 2.25 0 01-2.47-2.118c0-.62.28-1.186.74-1.544a3 3 0 005.78-1.128 2.25 2.25 0 012.47-2.118 2.25 2.25 0 012.47 2.118zM12.873 4.21a2.25 2.25 0 00-2.47-2.118 2.25 2.25 0 00-2.47 2.118c0 .62.28 1.186.74 1.544a3 3 0 005.78-1.128z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.47 2.118 2.25 2.25 0 01-2.47-2.118c0-.62.28-1.186.74-1.544a3 3 0 005.78-1.128 2.25 2.25 0 012.47-2.118 2.25 2.25 0 012.47 2.118z" />
    </svg>
);
...
export const RestoreIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-11.664 0l4.5-4.5m-4.5 4.5l-4.5-4.5m12 12.75a8.25 8.25 0 00-11.664 0l-3.181 3.183m11.664 0l-3.181-3.183m0 0l-4.5 4.5m4.5-4.5l4.5 4.5" />
    </svg>
);

export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-2.456M15 19.128L11.63 15.75M15 19.128l2.417-2.417M8.25 12a7.5 7.5 0 0115 0v3a7.5 7.5 0 01-7.5 7.5h-1.5a7.5 7.5 0 01-7.5-7.5v-3zm-3.75 0V7.5A7.5 7.5 0 0112 0h1.5a7.5 7.5 0 017.5 7.5v3.75m-21 0a7.5 7.5 0 017.5-7.5h1.5a7.5 7.5 0 017.5 7.5v3" />
    </svg>
);
...
export const TvIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m-3.75 0h7.5M9 16.5h.008v.008H9v-.008zm3 0h.008v.008h-.008v-.008zm3 0h.008v.008h-.008v-.008zM4.5 5.25h15a2.25 2.25 0 012.25 2.25v6.75a2.25 2.25 0 01-2.25 2.25H4.5a2.25 2.25 0 01-2.25-2.25V7.5a2.25 2.25 0 012.25-2.25z" />
    </svg>
);
...
export const BuildingStorefrontIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5a.75.75 0 01.75-.75h3a.75.75 0 01.75.75V21m-4.5 0H2.25a.75.75 0 00-.75.75v.008c0 .414.336.75.75.75h20.25a.75.75 0 00.75-.75v-.008a.75.75 0 00-.75-.75H13.5m-4.5 0v-4.5A2.25 2.25 0 0111.25 12h1.5a2.25 2.25 0 012.25 2.25v4.5m-4.5 0h4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    </svg>
);
...
export const DocumentArrowDownIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m.158 10.302L12 18.375m0 0l3.842-3.842M12 18.375V4.5m-4.5 15.75A2.25 2.25 0 015.25 18V4.5a2.25 2.25 0 012.25-2.25h6.75A2.25 2.25 0 0116.5 4.5v13.5a2.25 2.25 0 01-2.25 2.25H7.5" />
    </svg>
);
...
export const SignalIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.375c3.018 0 5.483 2.464 5.483 5.482v3.864m0 0c0 2.236-1.805 4.04-4.04 4.04a4.042 4.042 0 01-4.04-4.04v-3.864m4.04 0c0-3.018-2.465-5.482-5.483-5.482m11.106 1.752c2.196-.865 3.393-3.323 2.528-5.519s-3.323-3.393-5.519-2.528m-2.126 12.336c1.675-2.12 1.43-5.186-.69-6.861s-5.186-1.43-6.861.69m8.226 5.519c2.196-.865 3.393-3.323 2.528-5.519s-3.323-3.393-5.519-2.528m2.043 14.394c3.018 0 5.483-2.464 5.483-5.482v-3.864m-4.04 0c0 3.018 2.465 5.482 5.483 5.482" />
    </svg>
);

export const SignalSlashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75l16.5 16.5M21.75 8.25c-2.196-.865-4.654-.865-6.85 0a6.236 6.236 0 00-4.04 4.04c-.865 2.196-.865 4.654 0 6.85m8.94-1.206a4.52 4.52 0 00-1.206-8.94" />
    </svg>
);
