...
export const BuildingStorefrontIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A.75.75 0 0114.25 12h.01a.75.75 0 01.75.75v7.5m0 0H15M15 21a.75.75 0 00.75-.75v-7.5a.75.75 0 00-.75-.75h-.01a.75.75 0 00-.75.75v7.5m0 0h.01M16.5 21h-9a.75.75 0 000 1.5h9a.75.75 0 000-1.5zM18 21a.75.75 0 00.75-.75V6.75A.75.75 0 0018 6H6a.75.75 0 00-.75.75v13.5A.75.75 0 006 21h12zM6 12a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v7.5a.75.75 0 01-.75.75h-.01a.75.75 0 01-.75-.75v-7.5zM10.5 12a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75v7.5a.75.75 0 01-.75.75h-.01a.75.75 0 01-.75-.75v-7.5zM15 4.5a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75V5.25a.75.75 0 01-.75.75h-.01a.75.75 0 01-.75-.75V4.5zM9 4.5a.75.75 0 01.75-.75h.01a.75.75 0 01.75.75V5.25a.75.75 0 01-.75.75h-.01a.75.75 0 01-.75-.75V4.5zM3 15h2.25a.75.75 0 010 1.5H3a.75.75 0 010-1.5zm18 0h-2.25a.75.75 0 000 1.5H21a.75.75 0 000-1.5z" /></svg>
);

export const CloudArrowDownIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75v6.75m0 0l-3-3m3 3l3-3m-8.25 3.75a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z" />
    </svg>
);
...
export const CloudSlashIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.412 15.655L9.75 21.75l3.745-4.012M9.255 9.75l.386 1.158m-3.828 1.115l2.47-2.47m.053-3.478l1.46-1.46M21 12a8.982 8.982 0 00-1.282-4.471 9.043 9.043 0 00-4.407-3.213M21 12a9 9 0 01-9 9m-9-9a9 9 0 011.282-4.471 9.034 9.034 0 013.213-4.407m0 0a9.01 9.01 0 0110.912 0m-10.912 0c.264.11.53.227.803.35m9.306 0a8.982 8.982 0 01-4.471 1.282m0 0A8.988 8.988 0 0012 21m0 0a9.01 9.01 0 004.471-1.282m0 0c.273-.123.539-.24.803-.35M3 3l18 18" />
    </svg>
);
