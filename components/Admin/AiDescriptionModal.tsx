...
const DescriptionAssistantModal: React.FC<DescriptionAssistantModalProps> = ({
    isOpen,
    onClose,
    onApplyDescription,
    productName,
    ...
    const generateDescription = async () => {
        ...
        try {
            ...
            setError(err instanceof Error ? err.message : 'An unexpected error occurred while generating suggestions.');
        } finally {
            setIsLoading(false);
        }
    };
                        ...
                        <div className="p-6 flex-grow min-h-[300px] flex flex-col">
                            {isLoading && (
                                <div className="flex-grow flex flex-col items-center justify-center text-gray-600 dark:text-gray-300">
                                    ...
                                    <p className="mt-4 text-sm">Generating suggestions for "{productName}"...</p>
                                </div>
                            )}
                            {error && (
                                <div className="flex-grow flex flex-col items-center justify-center text-red-600 dark:text-red-400">
                                    <p className="font-semibold">Suggestion Failed</p>
...
export default DescriptionAssistantModal;
