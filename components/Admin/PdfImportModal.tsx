...
// FIX: Switched from a namespace import to named imports for pdfjs-dist to resolve type errors.
...
// FIX: Set workerSrc directly on the named import 'GlobalWorkerOptions'.
...
const PdfImportModal: React.FC<PdfImportModalProps> = ({ isOpen, onClose, onComplete }) => {
    ...
    const handleFileChange = async (selectedFile: File | null) => {
        ...
        try {
            ...
            // FIX: Use the named import 'getDocument' directly.
