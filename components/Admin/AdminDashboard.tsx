...
type SubTab = 'brands' | 'catalogues' | 'pamphlets' | 'screensaverAds' | 'tv-content' | 'trash' | 'settings' | 'storage' | 'backup' | 'users' | 'analytics';
...
const AdminDashboard: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900 bg-gradient-to-br from-gray-50 to-gray-200 dark:from-gray-900 dark:to-gray-800 flex flex-col">
            ...
            <main className="flex-grow p-4 sm:p-6 lg:p-8 pt-0 overflow-y-auto pb-24">
